...
_ALL_MARQO_CANDIDATES: tuple[MarqoCategoryCandidate, ...] = (
    # Tops (tops)
    ...
    # Layering Pieces (layering_pieces)
    ...
    # Office Wear / Formal (office_wear_formal)
    MarqoCategoryCandidate('suits', 'Suits', 'office_wear_formal', 'Office Wear / Formal'),
    MarqoCategoryCandidate('knit_tops', 'Knit Tops', 'office_wear_formal', 'Office Wear / Formal'),
    MarqoCategoryCandidate('work_dresses', 'Work Dresses', 'office_wear_formal', 'Office Wear / Formal'),
    MarqoCategoryCandidate('structured_dresses', 'Structured Dresses', 'office_wear_formal', 'Office Wear / Formal'),
    # Bottoms (bottoms)
    ...
    # Activewear / Sportswear (activewear_sportswear)
    MarqoCategoryCandidate('sports_tops', 'Sports Tops', 'activewear_sportswear', 'Activewear / Sportswear'),
    MarqoCategoryCandidate('sports_jackets', 'Sports Jackets', 'activewear_sportswear', 'Activewear / Sportswear'),
    MarqoCategoryCandidate('gym_leggings', 'Gym Leggings', 'activewear_sportswear', 'Activewear / Sportswear'),
    MarqoCategoryCandidate('bike_shorts', 'Bike Shorts', 'activewear_sportswear', 'Activewear / Sportswear'),
    MarqoCategoryCandidate('tracksuits', 'Tracksuits', 'activewear_sportswear', 'Activewear / Sportswear'),
    MarqoCategoryCandidate('tennis_skirts', 'Tennis Skirts', 'activewear_sportswear', 'Activewear / Sportswear'),
    # Dresses (dresses)
    ...
    MarqoCategoryCandidate('off_shoulder_dresses', 'Off-Shoulder Dresses', 'dresses', 'Dresses'),
    ...
    MarqoCategoryCandidate('oversized_hoodies', 'Oversized Hoodies', 'loungewear', 'Loungewear'),
    MarqoCategoryCandidate('soft_knit_sets', 'Soft Knit Sets', 'loungewear', 'Loungewear'),
    # Sets & One-Pieces (sets_one_pieces)
    ...
    MarqoCategoryCandidate('two_piece_sets', 'Two-Piece Sets', 'sets_one_pieces', 'Sets & One-Pieces'),
    MarqoCategoryCandidate('matching_sets', 'Matching Sets', 'sets_one_pieces', 'Sets & One-Pieces'),
    MarqoCategoryCandidate('co_ords', 'Co-ords', 'sets_one_pieces', 'Sets & One-Pieces'),
)

# Frontend assignment: each try-on slot scores these parent categories.
MARQO_TYPE_PARENTS: dict[str, tuple[str, ...]] = {
    "top": ("tops", "outerwear"),
    "bottom": ("bottoms", "skirts"),
    "dress": ("dresses", "office_wear_formal"),
}

# Built from the flat candidate list above by the frontend parent-category assignment, so a
# try-on slot scores only its mapped parent categories. To re-group, edit MARQO_TYPE_PARENTS.
MARQO_CANDIDATES_BY_TYPE: dict[str, tuple[MarqoCategoryCandidate, ...]] = {
    garment_type: tuple(
        candidate
        for candidate in _ALL_MARQO_CANDIDATES
        if candidate.parent_key in parents
    )
    for garment_type, parents in MARQO_TYPE_PARENTS.items()
}
